...
x64InstructionInfo::x64InstructionInfo(RegisterInfo* registerInfo, Ref<Context> ctx) : InstructionInfo(registerInfo, ctx) {
    ...
    m_patterns = std::move(
        ...
        .forOpcode(Node::NodeKind::ShiftLeft)
            ...
            .match(matchShiftLeftImmediateInv).emit(emitShiftLeftImmediateInv).withName("ShiftLeftImmediateInv")
        ...
        .forOpcode(Node::NodeKind::LShiftRight)
            ...
            .match(matchLShiftRightImmediateInv).emit(emitLShiftRightImmediateInv).withName("LShiftRightImmediateInv")
